...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            ...
            <a href="${pageContext.request.contextPath }/sys/user/loginOut.html">退出</a>
        </div>
    </header>
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/user/list">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/providerlist">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/sys/user/pagationUserInfo?method=query">用户管理</a></li>
